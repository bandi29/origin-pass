...
import { EUComplianceValidationMatrix } from "@/components/compliance/EUComplianceValidationMatrix"
import { getComplianceValidationForUser } from "@/lib/compliance-validation-server"
import { requireAuth } from "@/lib/require-auth"

export default async function EUCompliancePage() {
  const { user } = await requireAuth()
  const validationPayload = await getComplianceValidationForUser(user.id)
  ...
  return (
    <div className={spacing.pageStack}>
      ...
      <EUComplianceValidationMatrix initialPayload={validationPayload} />
    </div>
  )
}
