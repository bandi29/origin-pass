  ...
  return (
    <div className={spacing.pageStack}>
      <PageHeader
        ...
        actions={
          <Link href="/dashboard/product-identity/passports/create" className={primaryBtn}>
      ...
      <PassportListWithSearch
        ...
        actions={
          <div className="flex gap-2 sm:flex-shrink-0">
            <Link
              href="/dashboard/product-identity/passports/templates"
              className="rounded-lg border border-slate-200 px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50"
            >
              Templates
            </Link>
            <Link
              href="/dashboard/product-identity/passports/activity"
              className="rounded-lg border border-slate-200 px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50"
            >
              Activity
            </Link>
