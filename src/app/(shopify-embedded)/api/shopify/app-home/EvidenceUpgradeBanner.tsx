...
/**
 * Free-plan replacement for the evidence dropzone — a clean admin-native premium
 * banner. Uploads stay disabled (the certificates API also enforces this
 * server-side with a 403); the CTA starts the Shopify Billing approval flow.
 */
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-[#e0d8ff] bg-[#f8f6ff] px-4 py-3">
      <div className="flex min-w-[220px] flex-1 items-start gap-2.5">
        ...
        <div>
          <p className="text-sm font-medium text-[#2a2543]">
            Host supplier verification PDFs with the Grower plan
          </p>
          <p className="mt-0.5 text-xs leading-relaxed text-[#5c5675]">
            Upgrade to attach GOTS / OEKO-TEX certificates and make your passports audit-ready — $29/month, billed
            through Shopify.
          </p>
        </div>
      </div>
      ...
      >
        ...
        {upgrading ? "Opening Shopify billing…" : "Upgrade to Grower"}
      </button>
    </div>
  )
}
